      ...
      >
        <View style={styles.hero}>
          ...
          <Text style={styles.subtitle}>
            Your account setup was submitted. Please wait for the
            admin/receptionist to review and approve your account.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statusRow}>
            {checking ? (
              ...
              <Ionicons name="time-outline" size={18} color={T.slate500} />
            )}
            <Text style={styles.statusText}>
              {checking ? "Checking…" : "Pending approval"}
            </Text>
          </View>
          ...
          >
            {loggingOut ? (
              <ActivityIndicator size="small" color={T.slate800} />
            ) : null}
