...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        $data = $request->validate([
            ...
            'emergency_contact_number' => ['sometimes', 'nullable', 'string'],
            'occupation' => ['sometimes', 'nullable', 'string'],
            'philhealth_number' => ['sometimes', 'nullable', 'string'],
            'ptr_number' => ['sometimes', 'nullable', 'string'],
            'employment_status' => ['sometimes', 'nullable', 'in:contractual,permanent'],
            'active_in_service' => ['sometimes', 'nullable', 'boolean'],
