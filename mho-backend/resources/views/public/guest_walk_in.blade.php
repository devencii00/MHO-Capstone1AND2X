                ...
                <div class="p-6">
                    ...
                    <form id="publicGuestWalkInForm" method="POST" action="javascript:void(0)" class="grid gap-3 grid-cols-1 md:grid-cols-4 items-start">
                        <div>
                            ...
                            <input id="public_guest_firstname" type="text" required class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="First name">
                        </div>
                        <div>
                            <label for="public_guest_middlename" class="block text-[0.7rem] text-slate-600 mb-1">Middle name (optional)</label>
                            <input id="public_guest_middlename" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Middle name">
                        </div>
                        <div>
                            <label for="public_guest_lastname" class="block text-[0.7rem] text-slate-600 mb-1">Last name</label>
                            <input id="public_guest_lastname" type="text" required class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Last name">
                        </div>
                        <div>
                            <label for="public_guest_contact" class="block text-[0.7rem] text-slate-600 mb-1">Contact number (optional)</label>
                            <input id="public_guest_contact" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Mobile number">
                        </div>

                        <div class="min-w-0 md:col-span-2">
                            <label for="public_guest_service_search" class="block text-[0.7rem] text-slate-600 mb-1">Services</label>
                            <div class="relative">
                                <input id="public_guest_service_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search service">
                        ...
                        <div class="min-w-0 md:col-span-2">
                            ...
                            <div class="relative">
                                <input id="public_guest_doctor_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search doctor" disabled>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="public_guest_reason" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Reason for visit">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="rounded-lg border border-slate-200 bg-white px-3 py-2">
                                <label class="flex items-center gap-2 text-xs text-slate-700">
                                    <input id="public_priority_pwd" type="checkbox" class="accent-green-600">
                                    <span>Are you a PWD?</span>
                                </label>
                                <label class="mt-1 flex items-center gap-2 text-xs text-slate-700">
                                    <input id="public_priority_pregnant" type="checkbox" class="accent-green-600">
                                    <span>Are you pregnant?</span>
                                </label>
                                <label class="mt-1 flex items-center gap-2 text-xs text-slate-700">
                                    <input id="public_priority_senior" type="checkbox" class="accent-green-600">
                        ...
                        <div class="flex items-end self-end">
                            <button id="publicGuestWalkInSubmit" type="submit" class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-green-600 text-white text-[0.78rem] font-semibold hover:bg-green-700 transition-colors disabled:opacity-60 disabled:hover:bg-green-600">
    ...
    <div id="publicWalkInConfirmOverlay" class="hidden fixed inset-0 z-[60] bg-slate-900/40 items-center justify-center p-4">
        <div class="w-full max-w-sm rounded-2xl bg-white border border-slate-200 shadow-[0_12px_30px_rgba(15,23,42,0.24)] p-4">
            ...
            <div class="mt-4 flex items-center justify-end gap-2">
                ...
                <button type="button" id="publicWalkInConfirmOk" class="px-3 py-2 rounded-xl bg-green-600 text-white text-[0.78rem] font-semibold hover:bg-green-700">Confirm</button>
            </div>
        </div>
    </div>
