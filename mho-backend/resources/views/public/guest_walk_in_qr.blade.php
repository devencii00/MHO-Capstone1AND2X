                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="mt-4 w-full text-xs text-slate-600 break-words">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                            <a href="{{ $displayUrl }}" class="text-green-700 font-semibold hover:underline">{{ $displayUrl }}</a>
                        </div>
                        <!-- <div class="mt-3 text-[0.68rem] text-slate-400 uppercase tracking-widest mb-1">Static link (for printed signs)</div> -->
                        <!-- <div class="rounded-xl border border-slate-200 bg-white px-3 py-2">
                            <a href="{{ $staticUrl }}" class="text-green-700 font-semibold hover:underline">{{ $staticUrl }}</a>
                        </div> -->
                    </div>
                </div>
            </div>
