    ...
    <div class="rounded-2xl border border-slate-100 bg-slate-50 p-4">
       ...
       <form id="receptionGuestWalkInForm" class="grid gap-3 grid-cols-1 md:grid-cols-4 items-start">
            ...
            <div class="min-w-0 md:col-span-2">
                ...
                <div class="relative">
                    <input id="reception_guest_service_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search service">
            ...
            <div class="min-w-0 md:col-span-2">
                ...
                <div class="mb-1 text-[0.7rem] text-slate-500">&nbsp;</div>
                <div class="relative">
                    <input id="reception_guest_doctor_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search doctor" disabled>
    ...
    <div class="rounded-2xl border border-slate-100 bg-slate-50 p-4">
        ...
        <form id="receptionWalkInAccountForm" class="grid gap-3 grid-cols-1 md:grid-cols-3 items-start">
            <div class="min-w-0">
                ...
                <div class="relative">
                    <input id="reception_walkin_patient_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search patient">
            ...
            <div class="min-w-0">
                ...
                <div class="relative">
                    <input id="reception_walkin_service_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search service">
            ...
            <div class="min-w-0">
                ...
                <div class="relative">
                    <input id="reception_walkin_doctor_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Type to search doctor" disabled>
