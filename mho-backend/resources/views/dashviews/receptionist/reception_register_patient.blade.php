        ...
        <div class="p-5">
            ...
            <div class="mb-3 flex flex-col gap-2 md:flex-row md:items-end">
                ...
                <div class="w-full md:w-28 pt-1">
                    <button type="button" id="receptionPrRefreshBtn" class="w-full inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 hover:bg-slate-50">
