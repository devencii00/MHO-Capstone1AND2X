...
<div class="wrap">
    <!-- Page Title -->
    <div class="page-title">Laboratory Records</div>
    <div class="page-sub">List of all laboratory patient results.</div>

    <div class="container-fluid laboratory-records-container" style="padding-top: 8px;">
        <!-- Main Card -->
        <div class="border-0 shadow-none card laboratory-card">
            <div class="card-body laboratory-body">
                ...
                <div class="table-wrapper" id="printArea">
                    <table class="laboratory-table" id="laboratoryTable">
                        <thead>
                                ...
                                foreach ($groupedRecords as $pId => $pRecords) {
                                    ...
                                    foreach ($pRecords as $rec) {
                                        $modalData[$pId][] = [
                                            ...
                                            'status' => $rec->status,
                                            'view_url' => route('staff1.laboratory.result', $rec->id)
                                        ];
                                    }
                                }
                            @endphp
                            ...
                            <tr id="emptyRow">
                                <td colspan="7" style="text-align: center; padding: 24px; color: #8C8C8C;">
                                    <div style="display: flex; flex-direction: column; align-items: center; gap: 12px;">
                                        ...
                                        <span>No laboratory records found.</span>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
...
<style>
    ...
    @media print {
        ...
        .no-print, .btn-view-services, .btn-print, .btn-reset,
        .header-row, .pagination-section, .sidebar, .navbar,
        aside, nav, header, .page-title, .page-sub, .modal-overlay { display: none !important; }
        .laboratory-table th:last-child,
        .laboratory-table td:last-child { display: none !important; }
        .laboratory-card { border: none !important; box-shadow: none !important; }
        .laboratory-body { padding: 0 !important; }
    ...
    @media (max-width: 768px) {
        ...
        .laboratory-body { padding: 16px; }
        .filter-select, .btn-reset, .btn-print { font-size: 12px; height: 34px; }
        .search-input { height: 34px; font-size: 12px; }
        .laboratory-table tbody td, .table-header th { padding: 8px 10px; font-size: 12px; }
