...
<div class="wrap">
    <!-- Page Title -->
    <div class="page-title">X-Ray Records</div>
    <div class="page-sub">List of all x-ray patient results.</div>

    <div class="container-fluid xray-records-container" style="padding-top: 8px;">
        <!-- Main Card -->
        <div class="border-0 shadow-none card xray-card">
            <div class="card-body xray-body">
                ...
                <div class="table-wrapper" id="printArea">
                    <table class="xray-table" id="xrayTable">
                        <thead>
                                ...
                                foreach ($groupedRecords as $pId => $pRecords) {
                                    ...
                                    foreach ($pRecords as $rec) {
                                        $modalData[$pId][] = [
                                            ...
                                            'status' => $rec->status,
                                            'view_url' => route('staff1.results.xray.view', $rec->id)
                                        ];
                                    }
                                }
                            @endphp
                            ...
                            <tr id="emptyRow">
                                <td colspan="7" style="text-align: center; padding: 24px; color: #8C8C8C;">
                                    <div style="display: flex; flex-direction: column; align-items: center; gap: 12px;">
                                        ...
                                        <span>No x-ray records found.</span>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
...
<style>
    ...
    .xray-records-container { padding: 0; }
    .xray-card { border-radius: 2px; background-color: var(--white); border: 1px solid #F0F0F0; box-shadow: var(--shadow-light); }
    .xray-body { padding: 24px; }
    ...
    .xray-table { width: 100%; border-collapse: collapse; background-color: var(--white); }
    ...
    .xray-table tbody tr { border-bottom: 1px solid #F0F0F0; transition: background-color 0.2s; }
    .xray-table tbody tr:hover { background-color: #FAFAFA; }
    .xray-table tbody td { padding: 12px 16px; font-size: 13px; color: var(--text-dark); }
    ...
    @media print {
        ...
        .xray-table th:last-child, .xray-table td:last-child { display: none !important; }
        .xray-card { border: none !important; box-shadow: none !important; }
        .xray-body { padding: 0 !important; }
