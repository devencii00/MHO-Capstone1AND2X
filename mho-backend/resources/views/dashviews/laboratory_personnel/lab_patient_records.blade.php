    ...
    <div class="bg-white border border-slate-100 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-[0.75rem] text-slate-600 whitespace-nowrap">
                ...
                <tbody class="divide-y divide-slate-100" id="labRecordsTableBody">
                    <tr>
                        <td colspan="10" class="px-4 py-12 text-center">
                            <div class="flex flex-col items-center gap-2">
                                <div class="w-14 h-14 rounded-full bg-slate-50 flex items-center justify-center text-slate-300">
                                    <x-lucide-folder-open class="w-7 h-7" />
                                </div>
                                <p class="text-slate-400 text-[0.8rem] font-medium">No patient records found</p>
    ...
    function renderRows(rows) {
        ...
        if (!rows.length) {
            body.innerHTML =
                ...
                '<p class="text-slate-400 text-[0.8rem] font-medium">No matching records</p>' +
