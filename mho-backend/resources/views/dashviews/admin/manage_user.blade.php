<div class="bg-white border border-slate-200 rounded-[18px] p-5 shadow-[0_2px_10px_rgba(15,23,42,0.04)]">
    ...
    <div class="mb-3 flex flex-col gap-2 md:flex-row md:items-end">
        ...
        <div class="w-full md:w-28 pt-1">
            <button type="button" id="adminUserRefreshBtn" class="w-full inline-flex items-center justify-center gap-1.5 rounded-lg border border-orange-200 bg-orange-50 px-3 py-1.5 text-xs font-semibold text-orange-700 hover:bg-orange-100">
