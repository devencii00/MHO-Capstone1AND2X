<div class="bg-white border border-slate-200 rounded-[18px] p-5 shadow-[0_2px_10px_rgba(15,23,42,0.04)]">
    ...
    <div class="mb-4 flex items-center justify-end">
        <button type="button" id="adminChatbotAddTopOption" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-green-600 text-white text-[0.78rem] font-semibold hover:bg-green-700 transition-colors disabled:opacity-60 disabled:hover:bg-green-600">
    ...
    <div class="mb-3 flex flex-col gap-2 md:flex-row md:items-end">
        <div class="flex-1">
            ...
            <input id="admin_chatbot_search" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Search by button text or response">
        </div>
        <div class="w-full md:w-40">
            <label for="admin_chatbot_sort" class="block text-[0.7rem] text-slate-600 mb-1">Sort</label>
            <select id="admin_chatbot_sort" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none">
        ...
        <div class="p-5">
            ...
            <form id="adminChatbotEditForm" class="space-y-3">
                <div>
                    ...
                    <select id="adminChatbotEditParent" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none">
                        <option value="">None (top level)</option>
                    </select>
                </div>
                <div>
                    <label for="adminChatbotEditButtonText" class="block text-[0.7rem] text-slate-600 mb-1">Button text</label>
                    <input id="adminChatbotEditButtonText" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="e.g. Services">
                </div>
                <div>
                    <label for="adminChatbotEditResponseText" class="block text-[0.7rem] text-slate-600 mb-1">Bot response</label>
                    <textarea id="adminChatbotEditResponseText" rows="4" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="Bot response text"></textarea>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="flex items-center gap-2 pt-1">
                        <input id="adminChatbotEditStarting" type="checkbox" class="rounded border-slate-300 text-green-600 focus:ring-green-500">
                    ...
                    <div>
                        ...
                        <input id="adminChatbotEditSortOrder" type="number" min="0" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="0">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-2 pt-1">
                    ...
                    <button type="submit" id="adminChatbotEditSave" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-green-600 text-white text-[0.78rem] font-semibold hover:bg-green-700 transition-colors disabled:opacity-60 disabled:hover:bg-green-600">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function renderPreview(optionId) {
            ...
            html += '<div class="inline-flex items-center rounded-full bg-green-50 px-3 py-1 text-[0.68rem] text-green-800 font-semibold">Option #' + String(opt.id) + '</div>'
