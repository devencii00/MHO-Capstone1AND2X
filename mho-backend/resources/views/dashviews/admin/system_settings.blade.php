        ...
        <div class="rounded-2xl border border-slate-100 bg-slate-50/60 p-4">
            ...
            <form id="settingsNameForm" class="space-y-3">
                <div>
                    ...
                    <input id="settings_contact_number" type="text" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-[0.78rem] text-slate-800 focus:border-green-500 focus:ring-2 focus:ring-green-200 outline-none" placeholder="09xx xxx xxxx">
                </div>
                <div class="flex items-center justify-end pt-1">
                    <button type="button" id="settings_name_save" class="inline-flex items-center gap-2 rounded-xl bg-green-600 px-3 py-2 text-[0.78rem] font-semibold text-white hover:bg-green-700 disabled:opacity-60 disabled:hover:bg-green-600">
